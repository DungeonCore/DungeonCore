	...
	public AbstractNotDamageExplosion(Location l, float f) {
		...
		while (iterator.hasNext()) {
			...
			if (entityhuman.e(l.getX(), l.getY(), l.getZ()) < 4096.0D) {
				((EntityPlayer) entityhuman).playerConnection.sendPacket(new PacketPlayOutExplosion(l.getX(), l .getY(), l.getZ(), f, Lists.newArrayList(), (Vec3D) this.b().get(entityhuman)));
			}
		}
	}
