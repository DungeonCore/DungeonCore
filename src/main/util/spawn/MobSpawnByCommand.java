...
import main.mob.customEntity1_7.CustomEnderDragon;
...
public class MobSpawnByCommand{
	...
	//			a("summon 成功:" + localObject1_1.getName() + ":" + JavaUtil.getLocationString(loc));
	...
	//使わないのでコメントアウト
//	public static org.bukkit.entity.Entity getEntityByCommand(String[] paramArrayOfString) {
//		//summonがあったら取り除く
//		if (paramArrayOfString[0].equalsIgnoreCase("summon")) {
//			String[] newParam = new String[paramArrayOfString.length - 1];
//			System.arraycopy(paramArrayOfString, 1, newParam, 1, paramArrayOfString.length - 1);
//			paramArrayOfString = newParam;
//		}
//
//		String str = paramArrayOfString[0];
...
//	}
	...
	private static void a(String string) {
		DungeonLog.printDevelopln(string);
	}
