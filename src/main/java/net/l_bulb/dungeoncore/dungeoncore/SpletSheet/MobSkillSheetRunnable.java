...
import net.l_bulb.dungeoncore.mob.mobskill.MobSkillTargetingMethodType;
import net.l_bulb.dungeoncore.mob.mobskill.OldNormalMobSkill;
import net.l_bulb.dungeoncore.mob.mobskill.ParticleLocationType;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillExplosion;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillExplosionNoParticle;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillHealMob;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillKeepAwayTarget;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillLightningEffect;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillLightningEffect3;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillMobJump;
import net.l_bulb.dungeoncore.mob.mobskill.skillrunnable.MobSkillNothing;
...
public class MobSkillSheetRunnable extends AbstractSheetRunable {
  ...
  public double getDouble(String deta) {
    if (deta == null || deta.isEmpty()) { return 0; }
  ...
  public boolean isEmpty(String[] row, int index) {
    if (row[index] == null || row[index].isEmpty()) { return true; }
    return false;
  }
