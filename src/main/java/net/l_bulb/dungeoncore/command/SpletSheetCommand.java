...
import net.l_bulb.dungeoncore.dungeoncore.SpletSheet.Food2SheetRunnable;
...
import net.l_bulb.dungeoncore.dungeoncore.SpletSheet.Mob1SheetRunnable;
...
public class SpletSheetCommand implements CommandExecutor, TabCompleter {
  ...
  static {
    ...
    regist(new Food2SheetRunnable(sender));
  }
