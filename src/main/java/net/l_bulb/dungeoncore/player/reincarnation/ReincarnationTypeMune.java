...
public class ReincarnationTypeMune implements MenuSelectorInterface {
  ...
  // 転生出来ないときの表示用アイテム
  static ItemStack swordCantSelectItem = ItemStackUtil.getItem(ChatColor.RED + "剣レベルリンカー不可", Material.COBBLESTONE, ChatColor.WHITE
      + "条件に達していないため転生できません");
  static ItemStack magicCantSelectItem = ItemStackUtil.getItem(ChatColor.RED + "魔法レベルリンカー不可", Material.COBBLESTONE, ChatColor.WHITE
      + "条件に達していないため転生できません");
  static ItemStack bowCantSelectItem = ItemStackUtil.getItem(ChatColor.RED + "弓レベルリンカー不可", Material.COBBLESTONE, ChatColor.WHITE
      + "条件に達していないため転生できません");
