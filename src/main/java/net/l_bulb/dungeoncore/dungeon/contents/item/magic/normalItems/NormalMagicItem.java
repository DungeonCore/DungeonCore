...
public class NormalMagicItem extends MagicItemOld {
  ...
  public static List<ItemInterface> getAllItem() {
    ...
    arrayList.add(new NormalMagicItem("セイクリッド", 20, Material.STONE_HOE, new BlockData(Material.IRON_BLOCK), new SoundData(Sound.IRONGOLEM_HIT, 1,
        (float) 0.7)));
    arrayList.add(new NormalMagicItem("ジャベラス", 30, Material.IRON_HOE, new BlockData(Material.STAINED_CLAY, (byte) 11), new SoundData(
        Sound.ZOMBIE_METAL, 1, 1)));
    arrayList.add(new NormalMagicItem("ルーク", 40, Material.IRON_HOE, new BlockData(Material.STAINED_CLAY, (byte) 14), new SoundData(
        Sound.GHAST_FIREBALL, 1, 1)));
    arrayList
    ...
    arrayList.add(new NormalMagicItem("ジュピター", 60, Material.DIAMOND_HOE, new BlockData(Material.DIAMOND_BLOCK), new SoundData(Sound.GHAST_FIREBALL,
        1, 1)));
    arrayList.add(new NormalMagicItem("エルシオン", 70, Material.DIAMOND_HOE, new BlockData(Material.OBSIDIAN, (byte) 11), new SoundData(
        Sound.ZOMBIE_METAL, 1, (float) 0.1)));
    arrayList.add(new NormalMagicItem("セルシオ", 80, Material.DIAMOND_HOE, new BlockData(Material.OBSIDIAN, (byte) 11), new SoundData(
        Sound.ZOMBIE_METAL, 1, (float) 0.1)));
    return arrayList;
  }
