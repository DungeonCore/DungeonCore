...
public abstract class AbstractKeyItem extends AbstractItem implements KeyItemable {
  ...
  public String[] getDetail() {
    if (getDungeonLocation() != null) {
      return new String[] {
          getDungeonName() + "で使用可能",
          StringUtils.join(new Object[] { "x:", (int) getDungeonLocation().getBlockX(), " y:", (int) getDungeonLocation().getBlockY(), " z:",
              (int) getDungeonLocation().getBlockZ() }) };
    } else {
