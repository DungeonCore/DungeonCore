...
public class Shop {
  ...
  public Inventory getShopInventory() {
    ...
    Inventory createInventory = Bukkit.createInventory(null, (arrayList.size() / 9 + 1) * 9, getName() + " shop");
  ...
  public ShopItem fromShopItem(ItemStack shopItem, boolean error) {
    if (shopItem == null || shopItem.getType() == Material.AIR) { return null; }
    ...
    if (price == -1 || count == -1) { return null; }
