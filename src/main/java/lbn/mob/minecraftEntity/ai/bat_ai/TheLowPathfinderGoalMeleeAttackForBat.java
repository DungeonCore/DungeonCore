...
public class TheLowPathfinderGoalMeleeAttackForBat extends PathfinderGoal {
	World a;
...
//	protected double attackRange = -1;
	...
	public TheLowPathfinderGoalMeleeAttackForBat(EntityInsentient entitycreature, Class<?> oclass, LbnMobTag tag) {
	...
	public TheLowPathfinderGoalMeleeAttackForBat(EntityInsentient entitycreature, double d0, boolean flag) {
	...
	public boolean b() {
		...
		return entityliving == null ? false : (!entityliving.isAlive() ? false : (!this.isKillAura ? !this.b.getNavigation().m() : !this.b.getNavigation().m()));
	}
