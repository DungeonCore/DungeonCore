...
import main.chest.wireless.PersonalChestData;
...
public class PlayerManagerTest {
	public static void main(String[] args) throws IOException {
		...
		Type collectionType = new TypeToken<Set<PersonalChestData>>(){
			private static final long serialVersionUID = 2199382832408849845L;}.getType();
	...
	public static ArrayList<String> readFile(String filePath) throws IOException {
		...
		try(BufferedReader br = new BufferedReader(new FileReader(file));) {
			...
			DungeonLog.println(filePath + "ファイルが存在しないので読み込みを無視します");
		} catch (IOException e) {
			throw e;
		}
