...
public abstract class AbstractPluginCommand extends AbstractNotUsuallyCommand {
	...
	// @Override
	// public void execute(ICommandListener paramICommandListener, String[]
	// paramArrayOfString)
	// throws ExceptionUsage, CommandException {
	// CommandSender sender = null;
	// if (paramICommandListener instanceof net.minecraft.server.v1_8_R1.Entity)
	// {
	// sender = ((net.minecraft.server.v1_8_R1.Entity)
	// paramICommandListener).getBukkitEntity();
	...
	// } else {
	// new UnsupportedOperationException(paramICommandListener.getClass() + " is
	// unknow sender");
	// }
	// }
