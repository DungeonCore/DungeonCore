...
public class BossSpawnPoint extends SpletSheetMobSpawnerPoint {
  ...
  public int spawnMob() {
    ...
    if (existMobInNear != null) {
      nextSpawn = false;
      cancelReson = MessageFormat.format("mob is alive yet error.({0},{1},{2}) mob is exist yet!!", existMobInNear.getLocation().getBlockX(), existMobInNear.getLocation().getBlockY(), existMobInNear.getLocation().getBlockZ());
      return 0;
    }
