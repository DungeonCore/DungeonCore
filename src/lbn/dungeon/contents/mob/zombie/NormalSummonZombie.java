...
public class NormalSummonZombie extends AbstractSummonZombie {
	...
	public void onSpawn(PlayerCustomMobSpawnEvent event) {
		...
		case 10:
			...
			break;
		case 20:
			LivingEntityUtil.setEquipment(e, new ItemStack(Material.PUMPKIN),
					new ItemStack(Material.LEATHER_CHESTPLATE), null, null, 0);
			LivingEntityUtil.setItemInHand(e, new ItemStack(Material.WOOD_SWORD), 0);
			break;
		case 30:
			LivingEntityUtil.setEquipment(e, new ItemStack(Material.PUMPKIN),
					new ItemStack(Material.LEATHER_CHESTPLATE), new ItemStack(Material.LEATHER_LEGGINGS),
					new ItemStack(Material.LEATHER_BOOTS), 0);
			LivingEntityUtil.setItemInHand(e, new ItemStack(Material.WOOD_SWORD), 0);
			break;
		case 40:
			LivingEntityUtil.setEquipment(e, new ItemStack(Material.PUMPKIN),
		...
		case 50:
			LivingEntityUtil.setEquipment(e, new ItemStack(Material.PUMPKIN),
					...
					new ItemStack(Material.CHAINMAIL_BOOTS), 0);
			LivingEntityUtil.setItemInHand(e, new ItemStack(Material.STONE_SWORD), 0);
			break;
		case 60:
		...
		case 70:
			LivingEntityUtil.setEquipment(e, new ItemStack(Material.PUMPKIN),
					new ItemStack(Material.DIAMOND_CHESTPLATE), new ItemStack(Material.IRON_LEGGINGS),
