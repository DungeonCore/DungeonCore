...
final public class FinalFieldSetter {
	...
	private FinalFieldSetter() throws ReflectiveOperationException {
		...
		this.putObjectMethod = unsafeClass.getMethod("putObject", Object.class, long.class, Object.class);
	...
	public void set(final Object o, final Field field, final Object value) throws Exception {
		...
		final long fieldOffset = (long) this.objectFieldOffsetMethod.invoke(this.unsafeObj, field);
	...
	public void setStatic(final Field field, final Object value) throws Exception {
		...
		final long fieldOffset = (long) this.staticFieldOffsetMethod.invoke(this.unsafeObj, field);
