...
public class TitleSender {
	...
	static TitleSender sender = null;

	public static TitleSender getInstance() {
		if (sender == null) {
	...
	private TitleSender() {
		try {
			...
			Class<?> tmp_packetPlayout = getNMSClass("PacketPlayOutTitle"), tmp_ichatBase = getNMSClass("IChatBaseComponent"), tmp_packetPlayoutEnumtitle = getNMSClass("PacketPlayOutTitle$EnumTitleAction");
