	...
	public CustomPig(World world, LbnMobTag tag) {
		...
		try {
			...
			if (tag.getAiType() == AIType.NO_ATACK) {
				...
				this.goalSelector.a(9, new PathfinderGoalTempt(this, 1.2D, Items.CARROT_ON_A_STICK, false));
				this.goalSelector.a(9, new PathfinderGoalTempt(this, 1.2D, Items.CARROT, false));
			}

			//戦闘AIをセットする
			AttackAISetter.setAttackAI(this, tag);
			this.goalSelector.a(7, this.bk = new PathfinderGoalPassengerCarrotStick(this, 0.3F));
			this.goalSelector.a(8, new PathfinderGoalBreed(this, 1.0D));
