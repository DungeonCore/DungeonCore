...
public class AttackAISetter {
	...
	private static void setLongAI2(EntityInsentient e, LbnMobTag tag) {
		// 対象が7マスよりも近い場合は無視する
		e.goalSelector.a(4, new PathfinderGoalAvoidTarget((EntityCreature) e,
				new AvoidTargetPredicate(tag.isSummonMob()), 7.0F, 1.6D, 2D));
		// 遠距離用のAI
		TheLoWPathfinderGoalArrowAttackForShortLongAI theLoWPathfinderGoalArrowAttack = new TheLoWPathfinderGoalArrowAttackForShortLongAI(
				(IRangedEntity) e, 1.25D, 20, 20.0F, tag);
	...
	private static void setShortLongAI(EntityInsentient e, LbnMobTag tag) {
		if (tag.getType() == EntityType.SKELETON) {
			...
			e.goalSelector.a(5, theLoWPathfinderGoalArrowAttack);
			// 近距離攻撃のAI
			TheLowPathfinderGoalMeleeAttack bq = new TheLowPathfinderGoalMeleeAttack((EntityCreature) e,
					getTargetEntityClass(tag.isSummonMob()), tag);
			bq.setKillAura(true);
			e.goalSelector.a(6, bq);
		} else {
			// 遠距離用のAI
			TheLoWPathfinderGoalArrowAttackForShortLongAI theLoWPathfinderGoalArrowAttack = new TheLoWPathfinderGoalArrowAttackForShortLongAI(
					(IRangedEntity) e, 1.25D, 20, 10.0F, tag);
			e.goalSelector.a(5, theLoWPathfinderGoalArrowAttack);
			// 近距離攻撃のAI
			TheLowPathfinderGoalMeleeAttack bq = new TheLowPathfinderGoalMeleeAttack((EntityCreature) e,
					getTargetEntityClass(tag.isSummonMob()), tag);
	...
	private static void setNormalAI(EntityInsentient e, LbnMobTag tag) {
		...
		if (tag.getType() == EntityType.SKELETON) {
			...
			e.goalSelector.a(6, new TheLowPathfinderGoalMeleeAttack((EntityCreature) e,
					getTargetEntityClass(tag.isSummonMob()), tag));
		}
	}
	 ...
	 * @throws IllegalArgumentException
	 */
	public static void removeAllAi(EntityLiving e)
			throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
		Field field = EntityInsentient.class.getDeclaredField("targetSelector");
		field.setAccessible(true);
		field.set(e, new PathfinderGoalSelector(
				(e.world != null) && (e.world.methodProfiler != null) ? e.world.methodProfiler : null));

		// goalSelectorを初期化
		Field field2 = EntityInsentient.class.getDeclaredField("goalSelector");
		field2.setAccessible(true);
		field2.set(e, new PathfinderGoalSelector(
				(e.world != null) && (e.world.methodProfiler != null) ? e.world.methodProfiler : null));
