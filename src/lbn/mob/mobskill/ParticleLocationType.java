...
public enum ParticleLocationType {
	MONSTER_UNDER("モンスターの足元", 0, true), MONSTER_BODY("モンスターの体", 1, true), MONSTER_UPPER("モンスターの上", 2,
			true), PLAYER_UNDER("プレイヤーの足元", 0,
					false), PLAYER_BODY("プレイヤーの体", 1, false), PLAYER_UPPER("プレイヤーの上", 2, false);
